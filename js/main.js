...
const loadProducts = (vinos) => {
    let container = document.querySelector("#shop-content");
    for (const product of vinos) {
...
//Función que evita la duplicacion de los elementos
function addProductToCart(title, price, productImg) {
    ...
    if (flag == 0) {
        //Sweet Alert 2 - Alerta para informar lo que ha agregado
        Swal.fire({
            position: 'center',
            icon: 'success',
